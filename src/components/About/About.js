...
export const About = () => {
  ...
  return (
    <div>
      <section class="pb-12 bg-gradient-to-b from-[#fb831f] via-[#f69b4e] to-[#F7FAFC]">
        ...
        <div class="text-center space-x-4 mt-6">
          <button class="bg-[#fd7300] translate-y-1 text-[#fff] sm:text-lg text-xs font-bold py-2.5 px-6  rounded-full inline-flex items-center">
            <svg
